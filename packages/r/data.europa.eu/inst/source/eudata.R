...
#' Generate LLM-friendly context for data.europa.eu
#'
#' @return Character string with full function signatures and bodies
#' @export
europa_context <- function() {
  src_file <- NULL
  ...
  if (is.null(src_file)) src_file <- "clients/data.europa.eu.R"
  if (!file.exists(src_file)) {
    cat("# data.europa.eu context - source not found\n")
    return(invisible("# data.europa.eu context - source not found"))
  }
