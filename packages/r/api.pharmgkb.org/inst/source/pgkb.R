...
#' Generate LLM-friendly context for api.pharmgkb.org
#'
#' @return Character string with full function signatures and bodies
#' @export
pharmgkb_context <- function() {
  src_file <- NULL
  ...
  if (is.null(src_file)) src_file <- "clients/api.pharmgkb.org.R"
  if (!file.exists(src_file)) {
    cat("# api.pharmgkb.org context - source not found\n")
    return(invisible("# api.pharmgkb.org context - source not found"))
  }
