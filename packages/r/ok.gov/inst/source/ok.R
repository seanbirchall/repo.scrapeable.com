...
#'
#' Search the State of Oklahoma open data catalog by keyword.
#'
...
#'
#' Fetch actual data rows from an Oklahoma open data resource.
#'
...
#' @param sort Sort string (e.g. "CALENDAR_YEAR desc")
...
ok_context <- function() {
  ...
  if (is.null(src_file)) src_file <- "clients/ok.gov.R"
