...
#' Generate LLM-friendly context for api.obis.org
#'
...
obis_context <- function() {
  ...
  if (is.null(src_file)) src_file <- "clients/api.obis.org.R"
  if (!file.exists(src_file)) {
    cat("# api.obis.org context - source not found\n")
    return(invisible("# api.obis.org context - source not found"))
  }
